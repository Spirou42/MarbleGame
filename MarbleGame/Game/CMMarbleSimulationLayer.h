...
@property (nonatomic, assign) CCNode* objectsSpritesNode;						///< node for all other Sprites no matter if they are dynamic or static
@property (nonatomic, assign) CCNode* physicsSpritesNode;					///< containing physics helper objects
